...
public class DrawableUtils {
    ...
    /**
     * 自己定义的options，用来自定义一些图片加载失败等情况下的展示
     */
     ...
     * @param url
     */
    public static void displayRoundImgOnNet(final ImageView img, final String url, int id) {
     ...
     * @Description:压缩图片
     */
    public static Bitmap getNewBitmap(String filePath, int reqHeight, int reqWidth) throws IOException
    {
