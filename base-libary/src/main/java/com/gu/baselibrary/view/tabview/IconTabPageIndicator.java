package com.gu.baselibrary.view.tabview;
...
public class IconTabPageIndicator extends LinearLayout implements PageIndicator {
    ...
    private class TabView extends TextView {
        ...
        public TabView(Context context) {
            this(context, null, R.attr.mytabViews);
        }

        public TabView(Context context, AttributeSet attr, int defStyle) {
            super(context, attr, defStyle);
            TypedArray a = context.obtainStyledAttributes(attr, R.styleable.MyTabViews, defStyle, 0);
            iconWidth = a.getDimensionPixelSize(R.styleable.MyTabViews_iconWidth, 0);
            iconHeight = a.getDimensionPixelSize(R.styleable.MyTabViews_iconHeight, 0);
            a.recycle();
        }
